...
export const Footer = () => {
    ...
    return (
        <footer className="w-full h-[580px] bg-[#002372] flex justify-center items-end border-t">
            <div className="w-full h-[570px] bg-[#FF0000] flex flex-col gap-10 p-16">
                ...
                <div className="flex justify-center gap-4 text-white text-2xl font-bold">
                    <div className="border-r-2 pr-5 text-3xl flex flex-col justify-center gap-2">
                        <div className="flex">
                            <div className="flex">FONE
