import { NoteItemMasc } from "@/components/NoteItemMasc";
import { mainListMasc } from "@/data/mainList";
import Link from "next/link";

const Page = () => {

    const Masculino = mainListMasc

    return (
        <div className="pt-48 pb-20">
            <section className="bg-yellow-300 w-72 text-center p-8 m-auto mb-10">
                <p className="text-[#002372] text-xl font-bold">LINHAS MASCULINA</p>
            </section>
